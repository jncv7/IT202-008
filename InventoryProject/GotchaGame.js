...
function randomNumbers() {
    ...
    // this will bring that JS variable and will make it a PHP variable
    window.location.href = "https://web.njit.edu/~jcv7/it202008/InventoryProject/RecievedItem.php?gotten=" + gotten;
